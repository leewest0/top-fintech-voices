  ...
  return (
    ...
    >
          ...
          <ol className="grid gap-5 md:grid-cols-3">
            {milestones.map((milestone, i) => (
              <li key={milestone.title}>
                <Reveal delay={i * 100} className="bordered h-full rounded-2xl p-6">
                  <p
      ...
      <section className="mx-auto max-w-[1240px] px-5 py-16 md:px-10">
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            },
            {
              href: "/contact",
              label: "Get in touch",
              copy: "Pitches, partnerships and press — the editorial desk in Accra.",
            },
          ].map((card, i) => (
            <Reveal key={card.href} delay={i * 90}>
              <Link href={card.href} className="card flex h-full flex-col rounded-2xl p-6">
        ...
        <Reveal delay={280} className="panel mt-14 rounded-3xl p-8 text-center md:p-12">
