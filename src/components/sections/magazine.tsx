    ...
    >
      <div className="mx-auto grid max-w-[1240px] items-center gap-14 px-5 md:grid-cols-2 md:px-10">
        <Reveal>
          ...
          >
            {currentEdition.pages} pages on collaboration, cybersecurity,
            regulation, funding and the women reshaping the industry from Ghana
            to Côte d&rsquo;Ivoire and beyond. Order the print edition, or read
            the digital one free.
          </p>
